...
if (process.argv.length > 2 && process.argv.length !== 4) {
    ...
    scanner.scan(function(){
        ...
        // TODO: Connect machine to existing node and share tracklist data
    });
} else {
...
// TODO: Listen for incoming node connections to send/receive tracklist data
...
http.listen(port, function(){
    console.log('http server listening on', ip.address(), 'port', port);
});
